...
@Service
@AllArgsConstructor
public class AlmDataDeliverResponsibilityFieldModelConvertImpl implements AlmDataDeliverSpecialConverter {
    private final String FIELD = "responsibilityFieldModule";
    ...
    public void convert(TranscendObjectWrapper data) {
        ...
        if (value instanceof String) {
            ...
            MObject object = objectModelCrudI.getByBid(TranscendModel.DUTY_FIELD_MODULE.getCode(), strValue);
        ...
        if (value instanceof Collection) {
            ...
            List<MObject> list = objectModelCrudI.list(TranscendModel.DUTY_FIELD_MODULE.getCode(),
    ...
    public boolean isSupport(TranscendObjectWrapper entity) {
        ...
        return entity.getModelCode().equals(TranscendModel.AR.getCode());
    }
