 ...
 * 权限规则明细表(新增)
 * @author unknown
 * @TableName permission_plm_add_rule_item
 */
@TableName(value ="permission_plm_add_rule_item")
@Data
public class PermissionPlmAddRuleItem implements Serializable {
    /**
     * 自增主键id
     */
    ...
    public boolean equals(Object that) {
        ...
        PermissionPlmAddRuleItem other = (PermissionPlmAddRuleItem) that;
