 ...
 * 流程节点可见条件配置表
 * @author unknown
 * @TableName amp_flow_node_event
 */
@TableName(value ="apm_flow_node_event")
@Data
public class ApmFlowNodeEvent implements Serializable {
    /**
     * 
     */
    ...
    @TableField(exist = false)
    private List<ApmFlowDriveRelate> driveRelateList;
    ...
    public boolean equals(Object that) {
        ...
        ApmFlowNodeEvent other = (ApmFlowNodeEvent) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getNodeBid() == null ? other.getNodeBid() == null : this.getNodeBid().equals(other.getNodeBid()))
            && (this.getEventClassification() == null ? other.getEventClassification() == null : this.getEventClassification().equals(other.getEventClassification()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getNodeBid() == null) ? 0 : getNodeBid().hashCode());
        result = prime * result + ((getEventClassification() == null) ? 0 : getEventClassification().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", nodeBid=").append(nodeBid);
        sb.append(", eventClassification=").append(eventClassification);
