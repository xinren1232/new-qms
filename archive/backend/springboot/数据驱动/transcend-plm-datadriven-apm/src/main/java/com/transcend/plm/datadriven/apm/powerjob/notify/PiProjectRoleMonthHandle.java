...
@Component
@Slf4j
public class PiProjectRoleMonthHandle implements MapReduceProcessor {
    ...
    public ProcessResult process(TaskContext taskContext) throws Exception {
        ...
        commonMapper.deletePiProjectRoleMonth();
        commonMapper.insertPiProjectRoleMonth();
        return new ProcessResult(true, "PiProjectRoleMonthHandle process success");
    }
}
