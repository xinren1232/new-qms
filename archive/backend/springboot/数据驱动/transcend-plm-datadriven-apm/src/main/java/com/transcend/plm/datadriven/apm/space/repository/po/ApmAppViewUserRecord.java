 ...
 * 视图用户点击记录表
 * @author unknown
 * @TableName apm_app_view_user_record
 */
@TableName(value ="apm_app_view_user_record")
@Data
public class ApmAppViewUserRecord implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        ApmAppViewUserRecord other = (ApmAppViewUserRecord) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getAppViewConfigBid() == null ? other.getAppViewConfigBid() == null : this.getAppViewConfigBid().equals(other.getAppViewConfigBid()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getAppViewConfigBid() == null) ? 0 : getAppViewConfigBid().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", appViewConfigBid=").append(appViewConfigBid);
