 ...
 * 流程节点可见条件配置表
 * @author unknown
 * @TableName amp_flow_node_display_condition
 */
@TableName(value ="apm_flow_node_display_condition")
@Data
public class ApmFlowNodeDisplayCondition implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        ApmFlowNodeDisplayCondition other = (ApmFlowNodeDisplayCondition) that;
