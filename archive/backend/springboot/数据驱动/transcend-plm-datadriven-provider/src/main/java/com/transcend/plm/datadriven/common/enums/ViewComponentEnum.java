...
public enum ViewComponentEnum {
     ...
     *文件上传
     */
    FILE_UPLOAD(ViewComponentEnum.FILE_UPLOAD_CONSTANT, ViewComponentEnum.FILE_UPLOAD_CONSTANT,"文件上传"),
    /**
     *富文本
     */
     ...
     *级联选择
     */
    CASCADE("cascader", "cascader","级联选择"),

    /**
     *远程数据选择
     */
    REMOTE_DICT_TYPE("remoteDataType", "remoteDataType","远程数据选择"),
     ...
     *file-upload
     */
    public static final String FILE_UPLOAD_CONSTANT = "file-upload";
    /**
     *picture-upload
     */
    public static final String PICTURE_UPLOAD_CONSTANT = "picture-upload";

    /**
     *instance-select
     */
    public static final String REMOTE_DATA_TYPE = "remoteDataType";
