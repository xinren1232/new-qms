...
public class Assert {
     ...
     */
    public static void isTrue(boolean expression, String errorMsgTemplate, Object... params) throws AssertException {
        if (!expression) {
     ...
     * @throws AssertException if expression is {@code false}
     */
    public static void isFalse(boolean expression, String errorMsgTemplate, Object... params) throws AssertException {
        if (expression) {
            throw new AssertException(StrUtil.format(errorMsgTemplate, params));
        }
    }
     ...
     */
    public static void isNull(Object object, String errorMsgTemplate, Object... params) throws AssertException {
        if (object != null) {
            throw new AssertException(StrUtil.format(errorMsgTemplate, params));
        }
    }
     ...
     */
    public static <T> T notNull(T object, String errorMsgTemplate, Object... params) throws AssertException {
        if (object == null) {
            throw new AssertException(StrUtil.format(errorMsgTemplate, params));
        }
        return object;
    ...
    /**
     * 断言对象是否不为{@code null} ，如果为{@code null} 抛出{@link AssertException} 异常
     *
     * <pre class="code">
     ...
     * @throws AssertException if the object is {@code null}
     */
    public static <T> T notNull(T object) throws AssertException {
     ...
     */
    public static <T extends CharSequence> T notEmpty(T text, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @see StrUtil#isNotEmpty(CharSequence)
     */
    public static <T extends CharSequence> T notEmpty(T text) throws AssertException {
     ...
     */
    public static <T extends CharSequence> T notBlank(T text, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @see StrUtil#isNotBlank(CharSequence)
     */
    public static <T extends CharSequence> T notBlank(T text) throws AssertException {
     ...
     */
    public static String notContain(String textToSearch, String substring, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @throws AssertException 非子串抛出异常
     */
    public static String notContain(String textToSearch, String substring) throws AssertException {
     ...
     */
    public static Object[] notEmpty(Object[] array, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @throws AssertException if the object array is {@code null} or has no elements
     */
    public static Object[] notEmpty(Object[] array) throws AssertException {
     ...
     */
    public static <T> T[] noNullElements(T[] array, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @throws AssertException if the object array contains a {@code null} element
     */
    public static <T> T[] noNullElements(T[] array) throws AssertException {
     ...
     */
    public static <T> Collection<T> notEmpty(Collection<T> collection, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @throws AssertException if the collection is {@code null} or has no elements
     */
    public static <T> Collection<T> notEmpty(Collection<T> collection) throws AssertException {
     ...
     */
    public static <K, V> Map<K, V> notEmpty(Map<K, V> map, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @throws AssertException if the map is {@code null} or has no entries
     */
    public static <K, V> Map<K, V> notEmpty(Map<K, V> map) throws AssertException {
     ...
     * @see Class#isInstance(Object)
     */
    public static <T> T isInstanceOf(Class<?> type, T obj, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @throws AssertException 如果子类非继承父类，抛出此异常
     */
    public static void isAssignable(Class<?> superType, Class<?> subType, String errorMsgTemplate, Object... params) throws AssertException {
     ...
     * @since 4.1.9
     */
    public static int checkIndex(int index, int size) throws AssertException, IndexOutOfBoundsException {
     ...
     * @since 4.1.9
     */
    public static int checkIndex(int index, int size, String errorMsgTemplate, Object... params) throws AssertException, IndexOutOfBoundsException {
    ...
    public static int checkBetween(int value, int min, int max) {
        if (value < min || value > max) {
            throwLengthMustBeBetweenException(min, max);
        }
        return value;
    }

    private static void throwLengthMustBeBetweenException(Object min, Object max) {
