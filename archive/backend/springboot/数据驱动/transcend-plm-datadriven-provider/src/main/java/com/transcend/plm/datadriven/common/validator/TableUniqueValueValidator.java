...
import com.transcend.plm.datadriven.common.annotation.RequestAnnotation;
...
import com.transcend.plm.datadriven.common.dao.TableUniqueValueService;
...
public class TableUniqueValueValidator implements ConstraintValidator<TableUniqueValue, Object> {
    ...
    public boolean isValid(Object fieldValue, ConstraintValidatorContext context) {
        ...
        String bid = RequestParamContext.get().getStr(TranscendModelBaseFields.BID);
