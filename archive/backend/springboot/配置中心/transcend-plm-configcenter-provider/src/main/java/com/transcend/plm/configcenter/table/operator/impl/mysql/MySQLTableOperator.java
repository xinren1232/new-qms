package com.transcend.plm.configcenter.table.operator.impl.mysql;
...
public class MySQLTableOperator extends BaseTableOperator {
	...
	public void createTable(Table table) throws SQLException {
		...
		for (int i = 0; i < columnList.size(); i++) {
			...
			if (StringUtils.isNotEmpty(defaultValue) && !Column.COLUMN_TYPE_CLOB.equals(cm.getColumnType())) {
