package com.transcend.plm.configcenter.space.repository.po;
...
public class ApmSpaceApp implements Serializable {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, bid, spaceBid, sphereBid, typeCode, type, modelCode, name, sort, createdTime, updatedTime, deleteFlag, enableFlag, visibleFlag, createdBy, updatedBy, tenantId, iconUrl, configContent, isVersionObject);
    }
