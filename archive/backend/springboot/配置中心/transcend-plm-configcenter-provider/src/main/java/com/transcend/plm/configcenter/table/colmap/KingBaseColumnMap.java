...
// * @description: KingBase 列的元数据到columnmodel的映射
// * @author: czm
// * @create: 2021-10-21
// **/
...
//        if("NUMBER".equals(typeName) || "NUMERIC".equals(typeName)) {//数值类型
//            columnLength = precision;
//        }
//        column.setFcolumnType(BeanUtils.isEmpty(length) ? typeName : typeName + "("+columnLength +")");
...
//            column.setColumnType(Column.COLUMN_TYPE_NUMERIC);
//            column.setIntLen(precision - scale);
//            column.setDecimalLen(scale);
//            int i = precision - scale;
//            if (i == 0 && scale == 0) {
...
//            column.setColumnType(Column.COLUMN_TYPE_TEXT);
//            return;
//        }
//    }
//}
