package com.transcend.plm.configcenter.common.dao;
...
public class TableUniqueValueService {
     ...
     *
     */
    private static void paramValidate(com.transcend.plm.configcenter.common.validator.UniqueValidateParam uniqueValidateParam) {
     ...
     *
     */
    private static void paramIdValidate(com.transcend.plm.configcenter.common.validator.UniqueValidateParam uniqueValidateParam) {
