...
import com.transcend.plm.configcenter.api.model.filemanagement.vo.PlanTimeParam;
import lombok.Data;

/**
 * 文件库复制规则
 * @TableName cfg_file_copy_rule
 */
@TableName(value ="cfg_file_copy_rule", autoResultMap = true)
@Data
public class CfgFileCopyRule implements Serializable {
    /**
     * 
     */
