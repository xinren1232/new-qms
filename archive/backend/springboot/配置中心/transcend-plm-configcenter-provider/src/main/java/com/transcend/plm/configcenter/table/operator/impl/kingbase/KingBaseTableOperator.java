package com.transcend.plm.configcenter.table.operator.impl.kingbase;
 ...
 * @description: KingBase数据库表操作的实现
 * @author: czm
 * @create: 2021-10-21
 **/
public class KingBaseTableOperator extends BaseTableOperator {
    @Override
...
//        sb.append(";");
        ...
        StringBuffer sb=new StringBuffer();
        sb.append("ALTER TABLE ").append(tableName).append(" ALTER COLUMN ").append(columnName).append(" TYPE ").append(column.getColumnType()).append("(").append(column.getCharLen()).append(")");
        jdbcTemplate.execute(sb.toString());
    }
