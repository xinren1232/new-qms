package com.transcend.plm.configcenter.api.feign.fallback;
...
@Slf4j
@Component
public class DemoClientFactory implements FallbackFactory<CfgObjectFeignClient> {

    @Override
    public CfgObjectFeignClient create(Throwable cause) {
