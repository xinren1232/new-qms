...
@Setter
@Getter
public class ObjectRelationVO extends BaseDto{
    ...
    @ApiModelProperty(value = "源对象名称", example = "V1")
    private String sourceObjName;

    @ApiModelProperty(value = "关联对象编码", example = "123")
    private String targetModelCode;

    @ApiModelProperty(value = "关联对象名称", example = "V1")
    ...
    private List<ObjectRelationAttrVO> relationAttr;
